          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
            ...
            >
              ...
              <p className="text-teal-50 mb-8 leading-relaxed">
                Junte-se a milhares de pessoas que estão cuidando melhor da sua saúde com nossa plataforma completa.
              </p>
          ...
          <div className="w-full max-w-md">
            ...
            <motion.div {...fadeInUp}>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 cursor-default">
                ...
                >
                  <Label htmlFor="firstName" className="text-slate-700">Primeiro Nome</Label>
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.2 }}
                >
                  <Label htmlFor="lastName" className="text-slate-700">Sobrenome</Label>
                  <div className="relative mt-2">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" />
                    <Input
                      id="lastName"
                ...
                >
                  ...
                  <div>
                    <Label htmlFor="idade" className="text-slate-700">Idade</Label>
                    <div className="relative mt-2">
